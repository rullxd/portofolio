...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/syachrul", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/syachrul-ramadani-994b462b6/", label: "LinkedIn Profile" },
  { icon: Instagram, link: "https://www.instagram.com/syahrul4you/", label: "Instagram Profile" }
];
        ...
        <script type="application/ld+json">{`
          {
            ...
            "sameAs": [
              ...
              "https://www.instagram.com/syahrul4you/"
            ]
          }
        `}</script>
      </Helmet>

      <div className="min-h-screen bg-[#030014] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] pt-10 sm:pt-12 lg:pt-14" id="Home">
        <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
          <div className="container mx-auto min-h-screen">
            <div className="flex flex-col lg:flex-row items-center justify-center min-h-[calc(100vh-3rem)] md:justify-between gap-0 sm:gap-12 lg:gap-20">
              {/* Left Column */}
