        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Saya adalah mahasiswa Teknologi Rekayasa Perangkat Lunak (TRPL) yang berfokus pada pengembangan Fullstack.
...
<a href="https://drive.google.com/file/d/1yFZLiSpsh4g-4PQa2xcwCNWjLpW4DFWo/view?usp=sharing" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
