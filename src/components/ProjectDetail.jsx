...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        github: selectedProject.github || "https://github.com/syachrul",
      };
  ...
  const projectUrl = `https://rullxd.dev/project/${toSlug(project.title)}`;

  return (
    <>
      <Helmet>
        <title>{project.title} — Syachrul</title>
        <meta
          name="description"
          content={
            project.description
        ...
        <meta
          property="og:title"
          content={`${project.title} — Syachrul`}
        />
        <meta
